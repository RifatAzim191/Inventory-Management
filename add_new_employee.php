...
echo"<link rel='stylesheet' href='allcss.css'>";
	...
	<article class='py-5 text-center text-dark'>
	 	<div>
	 		<h3 class='display-4 text-dark'>Add A New Employee</h3>
	 	</div>
	</article>
</section>
";
...
echo "<br>";
	...
	echo"<div align='center'>";
		echo "<label for= 'empname' class='btn btn-dark col-sm-1.5'>Employee Name:</label>";
		echo "<input type= 'text' name= 'emp_name' id=empname required>";
	echo "</p>";
	
	echo "<p>";
		echo "<label for= 'contact' class='btn btn-dark col-sm-1.5'>Phone Number:</label>";
		echo "<input type= 'text' name= 'contact_no' id=contact required>";
	echo "</p>";
	
	echo "<p>";
		echo "<label for= 'salary' class='btn btn-dark col-sm-1.5'>Salary:</label>";
		echo "<input type= 'text' name= 'slr' id=salary required>";
	echo "</p>";
	
	echo "<label for= 'dates' class='btn btn-dark col-sm-1.5'>Hire Date:</label>";
	...
	echo "<input type='submit' class='btn btn-success col-sm-1' value='Add'>";
